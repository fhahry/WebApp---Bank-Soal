...
<div class="container-xl px-4 mt-n10">
  <div class="card mb-4">
    <div class="card-body">
      ...
      <form action="actions/tambah-bank-soal.php" method="POST" enctype="multipart/form-data" onsubmit="return prepareSubmit()">
        ...
        <div class="mb-4">
          ...
          <div class="form-control p-0" style="min-height:200px;">
            <div id="editor-soal" style="min-height:200px;"></div>
          </div>
        ...
        <img id="preview_gambar_soal" class="img-fluid mt-2" style="max-height: 200px;">
        ...
        <?php
        $jawaban = ['A','B','C','D'];
        foreach($jawaban as $index => $huruf) {
          $id = $index + 1;
          echo '
          <div class="mb-4">
            <label class="form-label">Jawaban '.$huruf.'</label>
            <div class="row">
              <div class="col-md-7">
                <div class="form-control p-0" style="min-height:150px;">
                  <div id="editor-jawab'.$id.'" style="min-height:150px;"></div>
                </div>
                <input type="hidden" name="jawab'.$id.'" id="input-jawab'.$id.'">
              </div>
              <div class="col-md-5">
                <small class="form-label mt-2">Gambar Jawaban '.$huruf.'</small><br>
                <img id="preview_gambarjawab'.$id.'" class="img-fluid mt-2" style="max-height: 200px;">
                <div class="input-group mb-3">
                  <input class="form-control" type="file" id="gambarjawab'.$id.'" name="gambarjawab'.$id.'" accept="image/*">
                  <button type="button" class="btn btn-info" onclick="pasteImage(\'gambarjawab'.$id.'\', \'preview_gambarjawab'.$id.'\')">Paste Gambar</button>
                </div>
              </div>
            </div>
          </div><hr>';
